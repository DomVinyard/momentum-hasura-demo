  ...
  return (
    <>
      <Stack>
        ...
        <Center>
          <Avatar mt={-8} size="xl" name={donor?.name} src={donor?.avatar} />
        </Center>
        <Center>
          ...
          <TabPanels>
            <TabPanel>
              <Box px={4}>
                {/* <Center>
                  <Flex>
                    <Button colorScheme="blue" size="xs" variant={"ghost"}>
                      View on CRM →
                    </Button>
                  </Flex>
                </Center> */}
                ...
                {donor?.information?.map((info: any) => (
                  <Flex
                    bg={"#f5f5f5"}
                    mb={1}
                    p={2}
            ...
            <TabPanel>
              {donor?.correspondance.map((message: any) => (
                <Box
